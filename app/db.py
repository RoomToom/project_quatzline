...
# Псевдоним для доступа к пулу — используется для совместимости с импортами (костыль, скорее всего пизды получу ну но я же не могу database напрямую юзать или?)
database = pool
